...
| 측정 수치 | `experiments/E<N>-*.md` (+ raw는 `../results/`) |
| 개념 정리 | `concepts/*.md` |
| 실행 방법 | `howto/*.md` |
...
- 파일명: `P-001-hikari-pool-exhausted.md`, `D-004-gc-choice.md`, `E2-io-bound.md`, `concepts/backpressure.md`, `journal/2026-08-20-skeleton.md`

## 점검
- `bash wiki/check.sh` — frontmatter·링크·고아 페이지·번호 정합성. CI에도 같은 줄을 넣는다.
- 검색: `grep -rn "키워드" wiki/`
